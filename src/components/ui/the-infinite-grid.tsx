...
export const InfiniteGrid = ({ className, children }: { className?: string, children?: React.ReactNode }) => {
  ...
  return (
    <div
      ...
      className={cn(
        "relative w-full h-full flex flex-col items-center justify-center overflow-hidden bg-background",
        className
      )}
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        ...
        <div className="absolute right-[10%] top-[-10%] w-[20%] h-[20%] rounded-full bg-[#C3E41D]/10 blur-[100px]" />
