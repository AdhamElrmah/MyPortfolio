...
export default function AboutSection() {
  return (
    <section
      id="about"
      className="relative py-32 px-6 md:px-12 lg:px-24 bg-background overflow-hidden transition-colors duration-300"
    >
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 mt-12">
            <div className="group">
              <h4 className="text-[#C3E41D] font-bold mb-1 group-hover:translate-x-1 transition-transform">
                02+
              </h4>
